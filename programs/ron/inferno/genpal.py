...
vals = []
for pal in (fire, blue):
    Y, U, V = yuv(pal)
    for i in range(256):
        vals.append((Y[i] << 20) | (U[i] << 10) | V[i])

print('  type t_pal is array (0 to 511) of std_logic_vector(29 downto 0);')
print('  -- packed Y(29:20) U(28:10)=Cr V(9:0)=Cb, fire 0..255, blue 256..511')
lines = []
